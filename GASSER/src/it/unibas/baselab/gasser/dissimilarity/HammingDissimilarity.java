...
public class HammingDissimilarity implements IDissimilarityStrategy {


	public HammingDissimilarity() {}
	
	public HammingDissimilarity(TestSuite testSuite) {
	...
	public double computesDissimilarity(TestCase testCase1, TestCase testCase2) {
		...
		for (int i = 0; i < binaryStringt1.length; i++) {
			if (binaryStringt1[i] != (binaryStringt2[i]))
				sum++;
		}
		return sum;
	}
